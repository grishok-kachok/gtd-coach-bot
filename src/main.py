...
КОМАНДЫ: tuple[tuple[str, str, str | None], ...] = (
    ...
    ("strategy", "Стратегия: миссия, горизонты, цели, колесо баланса",
     "Пришли дашборд стратегии"),
    ("week", "Недельная стратсессия — подвести неделю, спланировать следующую",
     "Проведём недельную стратсессию"),
    ("month", "Месячная стратсессия — подвести месяц, сверить курс, спланировать следующий",
     "Проведём месячную стратсессию"),
    ("quarter", "Квартальная стратсессия — ревизия курса, не пора ли править годовые цели",
     "Проведём квартальную стратсессию"),
    ("year", "Годовая стратсессия — вектор, приоритеты, ценности на год вперёд",
     "Проведём годовую стратсессию"),
    ("end", "Закончить стратсессию, вернуться в обычный разговор",
     "Закончить стратсессию"),
    ("idea", "Хочу, чтобы коуч умел… — записать заявку",
