...
Метка источника привязана к устройству, а не к программе: сегодня разговор идёт
через VS Code, завтра через терминал — для памяти важно лишь, что это ноутбук,
а не Telegram.
