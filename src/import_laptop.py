"""Импорт реплик с ноутбука Василия в архив разговоров.

Метка источника привязана к устройству, а не к программе: чем именно Василий
пользуется на ноутбуке сегодня — дело десятое, для памяти важно лишь, что это
ноутбук, а не Telegram.
...
src.import_laptop` с JSON-строками на stdin. Формат строки:
